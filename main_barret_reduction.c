...
int main() {
    ...
    for (unsigned int i = 0; i < ITERATIONS; i++) {
        ...
        barrett_reduction_OURS(r_barrett, q_barrett, &fault_happened_loop, u, N, R, b_n_plus_1, number_word_count);
        ...
        __uint128_t zero2 = ( (mul2_sqsn) - (__uint128_t)sum2_ur) % mod_64minus2;
